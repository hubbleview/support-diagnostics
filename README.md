 ...
 - - Clicking [this link](https://github.com/elastic/support-diagnostics/releases) will bring you to the release page. The most recent release will usually be at the top. The most recent certified version will also have a link to the left of it that says: _Latest Release_.
